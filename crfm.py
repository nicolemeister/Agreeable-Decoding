...
result = {}
N = 1
# combinatorially test the convo/persona prompts
for i in range(len(prompt_dems)):
    for j in range(len(prompt_repubs)):
        prompt_dem = prompt_dems[i]
        prompt_repub = prompt_repubs[j]
        ...
        for k in range(N):
            ...
            out_file = open("../crfm_results/text-davinci-002/scoring_personas/{}_dem_{}_repub_{}_{}_{}.json".format(args.prompt_strength, i, j, k, args.question_type), "w")
